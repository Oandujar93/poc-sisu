package com.oandujar.sisu.infrastructure.spring;

import com.oandujar.sisu.application.commandbus.Command;
import com.oandujar.sisu.application.commandbus.CommandBus;
import com.oandujar.sisu.application.commandbus.CommandHandler;
...
public class SpringCommandBus implements CommandBus {
    ...
    @Override
    public <T> T dispatch(Command<T> command) throws Exception {

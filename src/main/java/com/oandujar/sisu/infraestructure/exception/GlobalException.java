...
public class GlobalException extends RuntimeException implements GenericException {
     ...
     */
    public GlobalException(ErrorCode pErrorCode) {
        super();
     ...
     */
    public GlobalException(ErrorCode pErrorCode, Object... pArguments) {
        super();
        this.setErrorCode(pErrorCode);
     ...
     */
    public GlobalException(ErrorCode pErrorCode, Exception newOriginalException) {
     ...
     * @param pArguments  argumentos para almacenar
     */
    public GlobalException(ErrorCode pErrorCode, Exception newOriginalException, Object... pArguments) {
        super(newOriginalException);
        this.setErrorCode(pErrorCode);
        this.arguments = pArguments;
    }
